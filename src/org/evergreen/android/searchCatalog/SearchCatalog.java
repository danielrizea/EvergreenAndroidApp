...
import org.opensrf.util.OSRFRegistry.WireProtocol;
...
public class SearchCatalog {
	 ...
	 */
	public SearchCatalog(String httpAddress, String locale) {
		super();
		...
		readIDLFile();
		//OSRFRegistry.registerObject("mvr", WireProtocol.ARRAY, new String[] {"title","author","doc_id","doc_type","pubdate","isbn","publisher","tcn","subject","type_of_resources","call_numbers","edition","online_loc","synopsis","physical_description","toc","copy_count","series","serials","foreign_copy_maps"});
	 ...
	 * 
	 * 
	   JSONObject complexParm = new JSONObject();

	 
	   try{
        	complexParm.put("org_unit", 1);
        	complexParm.put("depth", 0);
